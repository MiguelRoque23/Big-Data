...
joined_2 = JOIN filter_ratings BY movie_id, joines BY movie_id
dataset = FOREACH joined GENERATE movies::movie_id, movies::movie_name as movie_name, len_movies::title_length as title_length;
